export const metadata = {
  title: '5 Best Sake Izakayas in Tokyo (Part 3) | nom × nom',
  description: 'The final part of our ultimate Tokyo Sake Guide, focusing on premium Ultimate Pairings, Exclusive Introduction-only bars, and Casual Oden spots.',
};

export default function TokyoSakeIzakayaGuidePart3Layout({
    children,
}: {
